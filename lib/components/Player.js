...
var Player = (function(_Component) {
    ...
    function Player(props) {
        ...
        var _this = _possibleConstructorReturn(
            this,
            (Player.__proto__ || Object.getPrototypeOf(Player)).call(
                this,
                props
            )
        );
        ...
        _this.manager.subscribeToPlayerStateChange(
            _this.handleStateChange.bind(_this)
        );
        ...
        _this.handleMouseMove = (0, _utils.throttle)(
            _this.handleMouseMove.bind(_this),
            250
        );
        ...
        },
        {
            ...
            value: function getChildren(props) {
                var _ = props.className,
                    ...
                    propsWithoutChildren = _objectWithoutProperties(props, [
                        'className',
                        'children'
                    ]);
        ...
        },
        {
            ...
            value: function handleFullScreenChange() {
                this.actions.handleFullscreenChange(
                    _fullscreen2.default.isFullscreen
                );
            }
        },
        {
