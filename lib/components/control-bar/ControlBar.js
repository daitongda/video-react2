...
var ControlBar = (function(_Component) {
    ...
    function ControlBar(props) {
        ...
        var _this = _possibleConstructorReturn(
            this,
            (ControlBar.__proto__ || Object.getPrototypeOf(ControlBar)).call(
                this,
                props
            )
        );
    ...
    _createClass(ControlBar, [
        {
            ...
            value: function getDefaultChildren() {
                return [
                    _react2.default.createElement(_PlayToggle2.default, {
                        key: 'play-toggle',
                        order: 1
                    }),
        ...
        },
        {
            ...
            value: function getFullChildren() {
                return [
                    ...
                    _react2.default.createElement(
                        _RemainingTimeDisplay2.default,
                        {
                    ...
                    _react2.default.createElement(
                        _PlaybackRateMenuButton2.default,
                        {
                            rates: [1, 1.25, 1.5, 2],
                            key: 'playback-rate',
                            order: 10
        ...
        },
        {
            ...
            value: function getChildren() {
                ...
                var _props = this.props,
                    ...
                    parentProps = _objectWithoutProperties(_props, [
                        'className'
                    ]); // remove className
